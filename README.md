...
<div class="message-container">
    <div style="position: absolute; left: 20px; top: 20px; color: #red; background: #white; padding: 6px;">ぽかぽか陽気の穏やかな朝</div>
    <div style="position: absolute; left: 20px; top: 60px; color: #red; background: #white; padding: 6px;">花畑では、蝶々がのんびり飛んでいます</div>
